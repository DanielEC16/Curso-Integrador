...
<html lang="es">
  ...
  <body>
        ...
        <div class="container-swipper">
          ...
          <div class="swiper-container mySwiper">
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <img
                  src="https://media.revistaad.es/photos/60c227359ae22619e08751b2/master/w_1600%2Cc_limit/247747.jpg"
                  alt=""
                />
                <div class="card-description">
                  <div class="card-title">
        ...
        <div class="container-swipper">
          ...
          <div class="swiper-container mySwiper">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <img
                  src="https://www.oldskull.net/wp-content/uploads/2014/03/infinite-crisis-superman.jpg"
                  alt=""
                />
                <div class="card-description">
                  <div class="card-title">
              ...
              <div class="swiper-slide">
                <img
                  src="https://www.cuartomundo.cl/wp-content/uploads/2019/03/Hulk-181.jpg"
                  alt=""
                />
                <div class="card-description">
                  <div class="card-title">
              ...
              <div class="swiper-slide">
                <img
                  src="https://hablandodecomics.wordpress.com/wp-content/uploads/2012/01/portada-95-x-men.jpg"
                  alt=""
                />
                <div class="card-description">
                  <div class="card-title">
              ...
              <div class="swiper-slide">
                <img
                  src="https://www.oldskull.net/wp-content/uploads/2007/04/portadas-comics-oldskull-4.jpg"
                  alt=""
                />
                <div class="card-description">
                  <div class="card-title">
        ...
        <div class="container-swipper">
          <div class="swiper-container mySwiper">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <img
                  src="https://areajugones.sport.es/wp-content/uploads/2021/01/imagen-2021-01-27-105200.jpg"
                  alt=""
                />
                <div class="card-description">
                  <div class="card-title">
              ...
              <div class="swiper-slide">
                <img
                  src="https://static.listadomanga.com/d0199b31edc12dd8ec8abd9141693931.jpg"
                  alt=""
                />
                <div class="card-description">
                  <div class="card-title">
              ...
              <div class="swiper-slide">
                <img
                  src="https://somoskudasai.com/wp-content/uploads/2021/02/4yI8LVGA_2x.jpg"
                  alt=""
                />
                <div class="card-description">
                  <div class="card-title">
              ...
              <div class="swiper-slide">
                <img
                  src="https://pm1.aminoapps.com/6046/f6423b3a4f0358beca6bef5131b227697970215b_hq.jpg"
                  alt=""
                />
                <div class="card-description">
                  <div class="card-title">
              ...
              <div class="swiper-slide">
                <img
                  src="https://bazingacomics.cl/wp-content/uploads/2022/05/My-Hero-Academia-30.jpg"
                  alt=""
                />
                <div class="card-description">
                  <div class="card-title">
    ...
    <footer
      class="d-flex flex-wrap justify-content-between align-items-center p-5 my-4 border-top"
    >
